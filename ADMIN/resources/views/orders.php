...
<div class="overlay" id="overlay">
    ...
    <div class="body1">
        <img src="../../public/images/location.png" alt="Delivery Icon" />
        <strong>Delivery Address</strong>
        <span>Prk. 19 Lot 11, Prk. 5 Apokon, Tagum City, Davao del Norte</span>
    </div>

    <div class="body2">
        <img src="../../public/images/wallet.png" alt="Payment Icon" />
    ...
    <div class="footer1">
        <div class="footer0-1">
            <img src="../../public/images/clipboard.png" alt="Order Summary Icon" />
            <h5>Order Summary</h5>
        </div>
