...
<head>
  ...
  <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerHome.css">
    <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerAddADesign-display.css">
    <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerProfile.css">
    <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerOrder-display.css">
    <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerNewDesigns.css">
  <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerHotOrder-display.css">
  <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerNewOrder-display.css">
  <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerMyDesing-display.css">
  <link rel="stylesheet" href="http://localhost:3000/CUSTOMER/public/css/CustomerProductClicked-display.css">
...
<div class="main-container">
  <div class="nav">
    <div class="userNav">
      <img src="../../public/images/sampleimg.png" alt="">
    ...
    <div class="buttonsNav">
      <div class="menu">
        ...
        <a class="nav-add-button" id="add"><img src="../../public/images/tshirt%202.png" alt="">Add a Design</a>
      </div>
    </div>
  ...
  <div class="change-container" id="change-container">
          ...
          <ul class="card-list swiper-wrapper">
            <li class="card-item swiper-slide">
              <a href="" class="card-link" id="card-link">
                <img src="../../public/images/sampleimg.png" alt="" class="card-image">
            ...
            <li class="card-item swiper-slide">
              <a href="" class="card-link" id="card-link">
                <img src="../../public/images/sampleimage2.jpg" alt="" class="card-image">
            ...
            <li class="card-item swiper-slide">
              <a href="" class="card-link" id="card-link">
                <img src="../../public/images/sampleimage3.jpg" alt="" class="card-image">
            ...
            <li class="card-item swiper-slide">
              <a href="" class="card-link" id="card-link">
                <img src="../../public/images/sampleimage4.jpg" alt="" class="card-image">
    ...
    <div class="newDesigns">
      ...
      <div class="newDesigns-selection-container">
        <a class="add-design-button" id="add-design-button" href="#"><img src="../../public/images/add-design.png" alt="">Add A Design</a>
        <a href="" class="customize-design-button"><img src="../../public/images/custom-design.png" alt="">Customize a Design</a>
      </div>
    </div>
  </div>
</div>
<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>
<script src="../../public/js/customerJS.js"></script>
...
<div class="addtocart">
  ...
  <div class="quantity">
    <img src="../../public/images/sampleimage2.jpg" alt="">
