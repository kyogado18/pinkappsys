    ...
    <div class="profile-container">
        ...
        <div>
            <div class="profcus" id="profcus">
                <div class="item-01">
                    <div>
                        <img class="user-image" src="../../public/images/sampleimg.png" alt="" id="profile-pic">
                    </div>
                    <div class="insertImg">
    ...
    function addadesign(){
        ...
        <div class="add-a-design-container">
            <div class="import-design-container">
                <img src="../../public/images/default-tshirt.jpg" alt="" id="default-tshirt">
            ...
            <div class="completed-container">
                <div class="add-a-design-container">
                    <div class="import-design-container">
                        ...
                        <img src="../../public/images/sampleimg.png" alt="" id="default-tshirt">
                    </div>
                    <div class="design-info-container">
                        <div class="title-1">Sizes</div>
                        <div class="sizes-available">
